...
(function (root, factory) {
    ...
    /* Utilities */
    function loadImage(src, imageEl, crossOrigin) {
        ...
        if (img.src === src) {
            ...
            prom = new Promise(function (resolve, reject) {
                if (crossOrigin && src.substring(0,4).toLowerCase() === 'http') {
    ...
    function _bind(options, cb) {
        ...
        var prom = loadImage(url, self.elements.img, self.options.useCanvas || self.options.crossOrigin);
        prom.then(function () {
            if (self.options.useCanvas) {
